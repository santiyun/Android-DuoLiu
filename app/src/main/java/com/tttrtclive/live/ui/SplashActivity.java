...
public class SplashActivity extends BaseActivity {
    ...
    private void init() {
        ...
        Object mRoleObj = SharedPreferencesUtil.getParam(this, "Role", CLIENT_ROLE_ANCHOR);
        if (mRoleObj != null) {
            int saveRoleValue = (int) mRoleObj;
    ...
    public void onClickEnterButton(View v) {
        ...
        synchronized (clickLock) {
            ...
            SharedPreferencesUtil.setParam(this, "Role", mRole);
            // 6.加入频道
